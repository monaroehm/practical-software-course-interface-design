...
public class ScoreAchievement implements AchievementFactory.Achievement {
    private final String description;
    private final String name;
    private final int id;
    private final int goal;

    public ScoreAchievement(ResultSet rs) throws SQLException {
